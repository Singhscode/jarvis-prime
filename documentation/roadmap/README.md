...
- Added the owner-scoped `crm_clients` table.
- Added a small PostgreSQL transactional conversion function because the Supabase JavaScript client has no application-level transactions.
- Kept explicit routes, services, and repository methods: no generic CRUD, generic repository, or unnecessary abstraction.
