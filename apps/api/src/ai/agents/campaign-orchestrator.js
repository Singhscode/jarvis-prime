...
import { getVariantContent, recordResult } from '../../utils/ab-testing.js';
...
export async function runMultiChannelOutreach(client, campaign = null) {
  const { getDueProspects, getProspectsByStage, countMessagesSentToday } = await import('../../database/db.js');
