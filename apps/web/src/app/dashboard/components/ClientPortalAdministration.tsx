...
export default function ClientPortalAdministration({ clientId }: Props) {
  ...
  async function createContact(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setContactDraft(emptyContact); setNotice('Client contact added. Select the contact to send an invitation.'); await load();
