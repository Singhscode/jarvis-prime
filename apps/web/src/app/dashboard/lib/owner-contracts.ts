...
export type OwnerRenameInput = { name: string };
export type OwnerConvertLeadInput = OwnerRenameInput & { lead_id: string };
export type OwnerCreateProjectInput = OwnerRenameInput & { client_id: string };
export type OwnerCreateTaskInput = OwnerRenameInput;
export type OwnerUpdateTaskInput = Partial<OwnerRenameInput & { completed: boolean; assigned_user_id: string }>;
export type OwnerEmployeeInvitationInput = { full_name: string; email: string };
export type OwnerEmployeeInvitation = { id: string; status: 'pending'; expiresAt: string };
export type OwnerDocumentType = 'deliverable' | 'report';
...
export type OwnerDocument = { id: string; title: string; documentType: OwnerDocumentType; client: Pick<OwnerClient, 'id' | 'name'> | null; project: { id: string; name: string } | null; visibility: 'visible' | 'revoked'; createdAt: string; revokedAt: string | null };
