...
it('renders a recoverable directory error and retries to an explicit empty state', async () => {
  ...
  expect(await screen.findByText('No active employees match the selected filters.')).toBeTruthy();
